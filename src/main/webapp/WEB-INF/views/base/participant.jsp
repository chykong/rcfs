...
<body class="no-skin">
										...
										<table class="searchField" style="margin: 4px; padding: 4px;">
											<tr>
												...
												<td>
													...
													</button> <c:if test="${bln:isP('BaseParticipantAdd')}">
									...
									<c:forEach items="${list }" var="participant" varStatus="st">
										<tr>
											...
											<td><c:if test="${bln:isP('BaseParticipantUpdate')}">
													...
													<a href="javascript:delParticipant(${participant.id });">
														删除 </a>
												</c:if></td>
										</tr>
									</c:forEach>
							...
							<div class="widget-main">
								<div class="form-group">
									<div class="col-xs-12" style="margin-bottom: 10px">
										<span>请下载模板，按照模板格式整理数据：</span> <a
											href="${dynamicServer}/templates/import-participant-template.xls"
											target="_blank">导入项目参与人员信息.xls</a>
									</div>
								</div>
								<c:url value="/base/participant/importData.htm" var="import_url" />
								<form:form action="${import_url}" enctype="multipart/form-data"
									...
									<div class="form-group">
										...
										<div class="col-xs-12" align="center">
											...
											<button class="btn btn-white btn-primary" type="button"
												id="closeicon_modal" data-dismiss="modal">
	...
	<script type="text/javascript">
		$(function() {
			$("#btnSearch").bind('click', searchParticipant);
