...
public class PrjPresentation {
    ...
    public String toString() {
        return "PrjPresentation [id=" + id + ", prj_base_info_id=" + prj_base_info_id + ", file_path=" + file_path + ", file_name=" + file_name + ", content=" + content + ", title=" + title
                + ", progress=" + progress + ", last_modified_at=" + last_modified_at + ", last_modified_by=" + last_modified_by + ", created_by=" + created_by + ", created_at=" + created_at + "]";
    }
    public int getId() {
        return id;
    }
