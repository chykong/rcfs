...
public class PrjPreallocationDao extends BaseDao<PrjPreallocation, PrjPreallocationSearchVO> {
    ...
    public HouseholdersDetailDTO getByIdInApi(int id) {
        String sql = "select id,host_name,cog_land_area,map_id,location,status,total_homestead_area,remarks,before_area,between_area,after_area,no_sign_reason,appraise_co,demolish_co FROM t_prj_preallocation WHERE id=?";
