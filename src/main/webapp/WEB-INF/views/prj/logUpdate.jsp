					...
					<div class="row">
						<div class="col-xs-12">
							<form id="form" name="form" class="form-horizontal" action="update.htm" method="post">
								<input type="hidden" name="id" value="${prjLog.id }">
								<input type="hidden" name="backUrl" value="${backUrl }">
								<div class="form-group">
									<label class="col-sm-3 control-label">标题：</label>	
									<div class="col-sm-9">
										<select id="progress" name="progress" value="${prjLog.progress }">
								...
								<div class="form-group">
									<label class="col-sm-3 control-label">标题：</label>
									<div class="col-sm-9"> 
										<input id="title" name="title" type="text" class="col-xs-10 col-sm-5" placeholder="" value="${prjLog.title }"> <label
											id="nameTip"></label>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<script id="content" name="content" type="text/plain">${prjLog.content }</script>
