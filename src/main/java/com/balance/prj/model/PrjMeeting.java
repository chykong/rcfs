...
public String toString() {
	return "BaseMeeting [id=" + id + ", prj_base_info_id=" + prj_base_info_id + ", content=" + content + ", title=" + title + ", project_progress=" + project_progress + ", last_modified_at="
			+ last_modified_at + ", last_modified_by=" + last_modified_by + ", created_by=" + created_by + ", created_at=" + created_at + "]";
}
