        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <div class="page-header">
                    <h1>
                        公司管理
                        <small><i class="ace-icon fa fa-angle-double-right"></i> 修改公司
                        </small>
                    </h1>
                </div>
                <!-- /.page-header -->
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form id="form" name="form" class="form-horizontal" action="update.htm" method="post">
                            ...
                            <input type="hidden" name="id" value="${baseCompany.id }">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">公司名称：</label>
                                <div class="col-sm-9">
                                    <input id="name" name="name" type="text" class="col-xs-10 col-sm-5" placeholder=""
                                           value="${baseCompany.name }" readonly="readonly"><label id="nameTip"></label>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">公司类型：</label>
                                <div class="col-sm-9">
                                    <input id="type" type="text" name="type" class="col-xs-10 col-sm-5" placeholder=""
                                           value="${baseCompany.type }"><label id="typeTip"></label>
                                </div>
                            </div>
