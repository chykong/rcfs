				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<input type="hidden" name="id" value="${prjProsentation.id }">
								<input type="hidden" name="backUrl" value="${backUrl }">
								<div class="form-group">
									<label class="col-sm-3 control-label">阶段：</label>
									<div class="col-sm-9">
										<select id="progress" name="progress" value="${prjProsentation.progress }">
								...
								<div class="form-group">
									...
									<div class="col-sm-9"> 
										<input id="title" name="title" type="text" class="col-xs-10 col-sm-5" placeholder="" value="${prjProsentation.title }"> <label
											id="nameTip"></label>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<script id="introduction" name="architecture"
											type="text/plain">${prjProsentation.content }</script>
										</label>
									</div>
								</div>
